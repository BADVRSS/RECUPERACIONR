...
document.getElementById('formulario-25').addEventListener('submit', (event) => {
...
document.getElementById('formulario-24').addEventListener('submit', (event) => {
    event.preventDefault();
...
let imprimirNumeros24 = (numeros, resultadosElement) => {
...
document.getElementById('formulario-26').addEventListener('submit', (event) => {
    event.preventDefault();
...
document.getElementById('formulario-210').addEventListener('submit', (event) => {
    event.preventDefault();
...
let imprimirMarcasModelos = (marcasModelos, resultadosElement) => {
    resultadosElement.innerHTML = '';
...
document.getElementById('formulario-primos').addEventListener('submit', (event) => {
    event.preventDefault();
...
document.getElementById('formulario-pares1000').addEventListener('submit', (event) => {
    event.preventDefault();
...
let imprimirNumerosPares = (resultados, resultadosElement) => {
    resultadosElement.innerHTML = '';
...
document.getElementById('formulario-pares100').addEventListener('submit', (event) => {
    event.preventDefault();
...
document.getElementById('formulario-salario').addEventListener('submit', (event) => {
    event.preventDefault();
